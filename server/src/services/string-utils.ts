...
export function parseMainClass(value: string, group: string) {
...
export function deriveManifestGroup(value: string): string {
...
export function escapeGradleString(value: string): string {
  return value.replace(/\\/g, '\\\\').replace(/'/g, "\\'");
}
